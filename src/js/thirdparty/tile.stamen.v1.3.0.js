...
var retinaStr = isRetinaDisplay() ? '@2x' : '';

var SUBDOMAINS = "a. b. c. d.".split(" "),
    MAKE_PROVIDER = function(layer, type, minZoom, maxZoom) {
        return {
            "url":          ["http://{S}tile.stamen.com/", layer, "/{Z}/{X}/{Y}", retinaStr, '.', type].join(""),
            "type":         type,
    ...
    PROVIDERS =  {
        ...
        "trees-cabs-crime": {
            "url": "http://{S}.tiles.mapbox.com/v3/stamen.trees-cabs-crime/{Z}/{X}/{Y}" + retinaStr + ".png",
            "type": "png",
...
PROVIDERS["terrain-classic"].url = "http://{S}tile.stamen.com/terrain/{Z}/{X}/{Y}" + retinaStr + ".png";
